...
CREATE OR REPLACE PROCEDURE CHANGE_PAYMENT_LIMIT
(NEW_LIMIT PAYMENT_LIMIT.PAYMENT_LIMIT%TYPE)
LANGUAGE SQL
AS 
$$
	set timezone TO 'UTC-7';
	...
	UPDATE PAYMENT_LIMIT
 	SET VALID_TO = NOW()::TIMESTAMP, STATUS = 0
 	WHERE STATUS = 1;
	
 	INSERT INTO PAYMENT_LIMIT (PAYMENT_LIMIT)
 	VALUES (NEW_LIMIT);
$$
---++---
