...
CREATE TABLE DESTINATION_CARD
(
	CREDIT_ID INT PRIMARY KEY GENERATED ALWAYS AS IDENTITY
 	(START WITH 1 INCREMENT BY 1),
	ENCRYPTED_CARD_NUMBER VARCHAR(255),
	UNCRYPTED_CARD_NUMBER VARCHAR(255),
...
(
	LIMIT_ID INT PRIMARY KEY GENERATED ALWAYS AS IDENTITY
 	(START WITH 1 INCREMENT BY 1),
	PAYMENT_LIMIT FLOAT,
	STATUS INT DEFAULT 1,
	VALID_FROM DATE  DEFAULT CURRENT_DATE,
	VALID_TO DATE DEFAULT (CURRENT_DATE::TIMESTAMP + INTERVAL '10 YEARS')::DATE
);
